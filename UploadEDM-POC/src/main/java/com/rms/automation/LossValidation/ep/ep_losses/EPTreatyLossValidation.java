...
public class EPTreatyLossValidation {

    public static Boolean runTreatyLossValidationEP(String baselinePathEP, String actualPathEP, String outputPath) throws Exception {
