...
public class LoadData {
    ...
    public static Map<String, String> readApiEndPointsFromLocal() {
        ...
        apiendpoints = gson.fromJson(reader, apiendpoints.getClass());
